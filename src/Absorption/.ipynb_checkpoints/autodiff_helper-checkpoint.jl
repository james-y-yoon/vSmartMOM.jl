...
function absorption_cross_section_isoprene(model::AbstractCrossSectionModel,          # Model to use 
    ...
    function absorption_cross_section_autodiff(x ; model::AbstractCrossSectionModel = model, grid=grid, pressure=pressure, 
        ...
        return compute_absorption_cross_section_isoprene(model, grid, x[1], x[2], wavelength_flag=wavelength_flag);
    end
    ...
    if (autodiff)
        ...
        return compute_absorption_cross_section_isoprene(model, grid, pressure, temperature, wavelength_flag=wavelength_flag)
    end
